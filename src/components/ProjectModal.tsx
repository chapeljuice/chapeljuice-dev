...
const ProjectModal = ({ project, isOpen, onClose }: ProjectModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      {/* Backdrop */}
      <div 
        className="fixed inset-0 bg-teal-500 bg-opacity-50 transition-opacity"
        onClick={onClose}
      />
      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="relative bg-white rounded-xl shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 text-gray-500 hover:text-gray-700 transition-colors p-2"
          >
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-3">
                {project.technologies.map((tech, index) => (
                  <span 
                    key={index}
                    className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-teal-100 hover:text-teal-700 transition-colors"
                  >
                    {tech}
                  </span>
                ))}
            ...
            <div className="flex flex-wrap gap-4">
              {project.link && (
                <a 
                  ...
                  className="bg-teal-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-teal-700 transition-colors silkscreen-regular inline-flex items-center"
                >
              ...
              {project.github && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border-2 border-teal-600 text-teal-600 px-6 py-3 rounded-lg font-semibold hover:bg-teal-600 hover:text-white transition-colors silkscreen-regular inline-flex items-center"
                >
